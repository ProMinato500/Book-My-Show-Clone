...
const NavLg = () => {
    return(
        <>
        <div className="container mx-auto ml-20 px-4 flex items-center justify-between">
        <div className="flex items-center w-1/2">
            <div className="w-12 h-12">
                <img src="https://mpng.subpng.com/20180406/tle/kisspng-bookmyshow-visakhapatnam-ticket-company-coupon-shows-5ac7c2d7c3f5a1.3001505815230409838027.jpg" alt="logo" className="w-full h-full" />
            </div>
        ...
        <div className="flex items-center gap-6">
            <span className="text-gray-400 text-xs flex items-center hover:text-white cursor-pointer">
                    <strong>Kolkata</strong> < IoMdArrowDropdown/>
                </span>
