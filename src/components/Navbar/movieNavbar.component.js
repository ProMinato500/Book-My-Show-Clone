...
const NavLg = () => {
    return(
        <>
        <div className="container mx-auto px-4 flex ml-28 items-center justify-between">
        ...
        <div className="w-full flex items-center bg-white gap-3 px-3 ml-20 py-2 rounded-sm">
            <BiSearch />
